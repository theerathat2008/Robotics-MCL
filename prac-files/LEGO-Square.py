...
def moveForward(distance):
    ...
    BP.set_motor_position(BP.PORT_B, revolution + 10)
    BP.set_motor_position(BP.PORT_C, revolution + 30)
    return revolution

def turn(angle):
    BP.set_motor_position(BP.PORT_B, -angle * turn_constant + 5)
