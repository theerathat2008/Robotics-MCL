...
class Robot:
    ...
    def findObject(self):
        ...
        self.__getSonarRange(currentX, currentY, forwardExpectations, forwardReadings, backwardsExpectations, backwardsReadings)
    ...
    def hitObject(self, DESIRED_DISTANCE, KP, theta):
        ...
        # Align sonar to the object
        self.turnSensor(theta)
        ...
        while not hitTheObject:
            ...
            self.speedVelocity(velocity)

            self.checkBumper(hitTheObject)

        self.__turnSonar(- theta)
    ...
    def __getSonarRange(self, currentX, currentY, forwardExpectations, forwardReadings, backwardsExpectations, backwardsReadings):

        sonarAngle = self.BP.get_motor_status(self.sonarMotor)[2]

        expectedAngle = sonarAngle + 90
